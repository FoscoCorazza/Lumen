package com.corazza.fosco.lumenGame;
...
public class MainThread extends Thread {
    ...
    // the frame period
    private final static int	FRAME_PERIOD = 800 / MAX_FPS;
    ...
    private SchemeLayout gamePanel;
    ...
    public MainThread(SurfaceHolder surfaceHolder, SchemeLayout gamePanel) {
        super();
