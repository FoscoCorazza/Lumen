...
import static com.corazza.fosco.lumenGame.gameObjects.Star.getMainColor;
...
public abstract class Obstacle extends Segment {
    ...
    protected void initPaints() {
        ...
        Paints.put(getPaintPrefix() + TEXTPAINT, Consts.Colors.WHITE, scaledInt(16), Consts.detailFont);
    }
